...
so_file = ctypes.CDLL("./simulation.so")
...
# Theoretical PMF (Binomial Distribution for n=3, p=0.5)
n = 3
p = 0.5
...
plt.scatter(range(n+1), theoretical_pmf, color='b', label="Theoretical PMF", s=20, zorder=3)
