...
\textbf{Question}:\\
Find the area bounded by the ellipse $\frac{x^2}{a^2} + \frac{y^2}{b^2} = 1$.
\\
\textbf{Solution: }\\
...
\end{align}
assuming  $a = 2, b = 3$, the area bounded by the ellipse $\frac{x^2}{4} + \frac{y^2}{9} = 1$.
...
\begin{align}
   J = 8\pi \approx 18.84955592153876
\end{align}
