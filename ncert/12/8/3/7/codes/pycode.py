...
plt.scatter(coordinatesLine[0,:], coordinatesLine[1,:], label="Line: 2y = 3x + 12", color="red", linewidths = 1)
plt.scatter(coordinatesParabola[0,:], coordinatesParabola[1,:], label="Parabola: 4y = 3$x^2$", color="blue", linewidths = 1)
