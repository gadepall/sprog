...
plt.plot(x_values, sim1, label='Trapezoid', linewidth=1, color='red')
plt.plot(x_values, sim2, label='Z-transform', linewidth=10, color='yellow')
plt.plot(x_values, theory, label='Theory (cos(x))',linewidth=1, color='blue')
plt.xlabel('x')
plt.ylabel('y')
