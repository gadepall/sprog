...
dim = 2
matrix = np.array([[1, -3], [1, -7]], dtype=np.float64)
b = np.array([10, -30], dtype=np.float64)
...
plt.plot(x_vals, line1, label="x - 3y= 10", color='blue')
plt.plot(x_vals, line2, label="x - 7y =-30", color='red')
