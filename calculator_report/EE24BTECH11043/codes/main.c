// main.c
// Pure C calculator for ATmega328P
//
// This code drives a 16x2 LCD (using a 4-bit interface) and reads
// numeric and function buttons along with two shift buttons.
// It evaluates arithmetic expressions using a recursive descent parser.
// All Arduino-specific String functions are replaced by pure C string routines.
